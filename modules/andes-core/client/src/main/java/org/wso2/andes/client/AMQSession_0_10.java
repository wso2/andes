...
import static org.wso2.andes.transport.Option.BATCH;
import static org.wso2.andes.transport.Option.NONE;
import static org.wso2.andes.transport.Option.SYNC;
import static org.wso2.andes.transport.Option.UNRELIABLE;
...
import org.wso2.andes.client.AMQDestination.Binding;
...
import org.wso2.andes.client.message.FieldTableSupport;
import org.wso2.andes.client.message.MessageFactoryRegistry;
import org.wso2.andes.client.message.UnprocessedMessage_0_10;
import org.wso2.andes.client.messaging.address.Link;
import org.wso2.andes.client.messaging.address.Link.Reliability;
import org.wso2.andes.client.messaging.address.Node.ExchangeNode;
import org.wso2.andes.client.messaging.address.Node.QueueNode;
    ...
    implements SessionListener
{
    ...
    protected org.wso2.andes.transport.Connection _qpidConnection;
     ...
     */
    AMQSession_0_10(org.wso2.andes.transport.Connection qpidConnection, AMQConnection con, int channelId,
    ...
    void flushAcknowledgments(boolean setSyncBit)
    {
        synchronized (unacked)
        {
            ...
            {
                messageAcknowledge
                    (unacked, _acknowledgeMode != org.wso2.andes.jms.Session.NO_ACKNOWLEDGE,setSyncBit);
                clearUnacked();
            }
        }
    }
