 ...
 * For each {@link org.wso2.andes.client.protocol.AMQProtocolHandler} there is a separate state manager.
 *
 * The AMQStateManager is now attached to the {@link org.wso2.andes.client.protocol.AMQProtocolHandler} and that is the sole point of reference so that
