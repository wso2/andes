...
public class CompositeDataHelper {
    ...
    public class SubscriptionCompositeDataHelper {
        ...
        public CompositeDataSupport getSubscriptionAsCompositeData(AndesSubscription subscription, long
            ...
            return new CompositeDataSupport(subscriptionCompositeType, SUBSCRIPTION_COMPOSITE_ITEM_NAMES.toArray(new
                    String[SUBSCRIPTION_COMPOSITE_ITEM_NAMES.size()]), getSubscriptionItemValue(subscription,
                    pendingMessageCount));
        }
    ...
    public class MessagesCompositeDataHelper {
         ...
         * @param andesMessage      The {@link AndesMessageMetadata} object representing the message.
        ...
        public CompositeDataSupport getMessageAsCompositeData(ProtocolType protocolType, AndesMessage andesMessage,
            ...
            return new CompositeDataSupport(messageCompositeType, MESSAGE_COMPOSITE_ITEM_NAMES.toArray(new
                    String[MESSAGE_COMPOSITE_ITEM_NAMES.size()]), getMessageItemValue(protocolType, andesMessage,
                    getMessageContent));
        }
        ...
        private void setMessageCompositeType() throws OpenDataException {
            ...
            messageCompositeType = new CompositeType("Message", "Message details", MESSAGE_COMPOSITE_ITEM_NAMES
