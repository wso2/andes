...
public class SubscriptionStore {
     ...
     * @throws AndesException
     */
    public Set<AndesSubscription> getClusterSubscribersForDestination(String destination, boolean isTopic, SubscriptionType subscriptionType) throws AndesException {
        Set<AndesSubscription> subscriptions = new HashSet<AndesSubscription>();
        ...
        if (isTopic) {
            ...
            if (null != queueSubscriptions) {
                for (AndesSubscription andesSubscription : queueSubscriptions) {
                    if (andesSubscription.isBoundToTopic() && andesSubscription.isDurable()) {
                        subscriptions.add(andesSubscription);
                    }
                }
            }
...
//        }
     ...
     * @throws AndesException
     */
    public Set<LocalSubscription> getActiveLocalSubscribersForQueuesAndTopics(String destination) throws AndesException {
     ...
     * @throws AndesException
     */
    public int numberOfSubscriptionsInCluster(String destination, boolean isTopic, SubscriptionType subscriptionType) throws
            AndesException {
     ...
     */
    private Set<AndesSubscription> getClusterSubscriptionList(String destination, boolean isTopic, SubscriptionType subscriptionType) throws AndesException {
     ...
     */
    public Set<AndesSubscription> getActiveClusterSubscriptionList(String destination, boolean isTopic, SubscriptionType subscriptionType) throws AndesException {
     ...
     */
    public Set<AndesSubscription> replaceClusterSubscriptionListOfDestination(String destination, Set<AndesSubscription> newSubList, boolean isTopic) {
...
//            oldSubscriptionList.addAll(subscriptionBitMapHandler.getAllClusteredSubscriptions(destination, newSubList));
    ...
    public synchronized void createDisconnectOrRemoveClusterSubscription(AndesSubscription subscription, SubscriptionChange type) throws AndesException {
        ...
        boolean topicSubscriptionMap = subscription.isBoundToTopic() && !subscription.isDurable();
