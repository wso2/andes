...
/**
 * Qpid related objects that are referenced throughout QPid code are stored in this data holder
 */
public class QpidDataHolder {

    private static QpidDataHolder instance = new QpidDataHolder();

    private VirtualHostConfigSynchronizer virtualHostConfigSynchronizer;

    public static QpidDataHolder instance() {
        return instance;
    }

    private QpidDataHolder (){
    }
