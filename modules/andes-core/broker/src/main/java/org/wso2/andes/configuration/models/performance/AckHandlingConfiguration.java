...
/**
 * Configuration model for message acknowledgement related configs
 */
@Configuration(description = "Message acknowledgement related configurations")
public class AckHandlingConfiguration {
