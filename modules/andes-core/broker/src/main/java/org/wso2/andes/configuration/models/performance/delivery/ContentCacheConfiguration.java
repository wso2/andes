 ...
 */
@Configuration(description = "Content cache related configurations")
public class ContentCacheConfiguration {
    ...
    @Element(description = "Specify the time in seconds that each entry should be automatically removed from the cache"
            + " after the entry's creation")
