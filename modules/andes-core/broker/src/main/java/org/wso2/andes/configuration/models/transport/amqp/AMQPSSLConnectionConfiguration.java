...
/**
 * Configuration model for ssl connection in messaging transports
 */
@Configuration(description = "Broker messaging transport based default connection config")
public class AMQPSSLConnectionConfiguration {

    @Element(description = "Enabler for ssl connection")
    private boolean enabled = true;

    @Element(description = "Port for ssl connection")
