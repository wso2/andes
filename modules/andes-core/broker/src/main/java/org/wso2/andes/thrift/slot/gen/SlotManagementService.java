...
public class SlotManagementService {
  ...
  public interface Iface {
    ...
    public long updateCurrentMessageIdForSafeZone(long messageId) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void updateCurrentMessageIdForSafeZone(long messageId, org.apache.thrift.async.AsyncMethodCallback<AsyncClient.updateCurrentMessageIdForSafeZone_call> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public long updateCurrentMessageIdForSafeZone(long messageId) throws org.apache.thrift.TException
    {
      send_updateCurrentMessageIdForSafeZone(messageId);
      return recv_updateCurrentMessageIdForSafeZone();
    }

    public void send_updateCurrentMessageIdForSafeZone(long messageId) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void updateCurrentMessageIdForSafeZone(long messageId, org.apache.thrift.async.AsyncMethodCallback<updateCurrentMessageIdForSafeZone_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      updateCurrentMessageIdForSafeZone_call method_call = new updateCurrentMessageIdForSafeZone_call(messageId, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class updateCurrentMessageIdForSafeZone_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public updateCurrentMessageIdForSafeZone_call(long messageId, org.apache.thrift.async.AsyncMethodCallback<updateCurrentMessageIdForSafeZone_call> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor implements org.apache.thrift.TProcessor {
    ...
    private static class updateCurrentMessageIdForSafeZone<I extends Iface> extends org.apache.thrift.ProcessFunction<I, updateCurrentMessageIdForSafeZone_args> {
      ...
      protected updateCurrentMessageIdForSafeZone_result getResult(I iface, updateCurrentMessageIdForSafeZone_args args) throws org.apache.thrift.TException {
        updateCurrentMessageIdForSafeZone_result result = new updateCurrentMessageIdForSafeZone_result();
        result.success = iface.updateCurrentMessageIdForSafeZone(args.messageId);
        result.setSuccessIsSet(true);
        return result;
      }
    }
