...
/**
 * Interface to handle cluster subscriptions when there are wildcards are involed.
 */
public interface ClusterSubscriptionHandler {
    ...
    /**
     * Update a given subscription with a new subscription object.
     *
     * @param updatedSubscription The new object reference to the existing subscription
     */
