...
/**
 * Configuration model for slots related configs
 */
...
public class SlotsConfiguration {
    ...
    private long  messageAccumulationTimeout = 2000;

    @Element(description ="Time interval which broker check for slots that can be marked as 'ready to deliver' \n"
            + "(- slots which have a aged more than 'messageAccumulationTimeout') NOTE: specified in milliseconds")
    ...
    public long getMessageAccumulationTimeout() {
