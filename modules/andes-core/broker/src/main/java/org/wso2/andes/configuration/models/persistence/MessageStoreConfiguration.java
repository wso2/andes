 ...
 */
@Configuration(description = "Message store related configs")
public class MessageStoreConfiguration {

    @Element(description = "Message store impl class name")
    private String className = "org.wso2.andes.store.rdbms.RDBMSMessageStoreImpl";

    @Element(description = "Datasource name of message store")
    private String dataSource = "WSO2MBStoreDB";

    @Element(description = "Property of message store")
