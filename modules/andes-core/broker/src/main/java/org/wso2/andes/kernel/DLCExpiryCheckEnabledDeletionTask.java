...
public class DLCExpiryCheckEnabledDeletionTask extends PeriodicExpiryMessageDeletionTask {
    ...
    public void run() {
        /**
         * When DLC expiry check is enabled delete the expired messages from DLC regardless of queue
         * name or message id
         */
        deleteExpiredMessagesFromDLC();
        /**
         * After delete the messages from DLC then run a queue wise check for expired messages in the
         * range of unallocated zone
         */
