...
public class QpidConfig
{
    ...
    private SecurityMechanism[] securityMechanisms = 
        new SecurityMechanism[]{new SecurityMechanism("PLAIN","org.wso2.andes.security.UsernamePasswordCallbackHandler"),
                                new SecurityMechanism("CRAM_MD5","org.wso2.andes.security.UsernamePasswordCallbackHandler")};

    private SaslClientFactory[] saslClientFactories =
        new SaslClientFactory[]{new SaslClientFactory("AMQPLAIN","org.wso2.andes.security.amqplain.AmqPlainSaslClientFactory")};
