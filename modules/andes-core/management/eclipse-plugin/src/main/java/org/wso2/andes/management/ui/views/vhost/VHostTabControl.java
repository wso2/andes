 ...
 *
 */
package org.wso2.andes.management.ui.views.vhost;

import static org.wso2.andes.management.ui.Constants.DEFAULT_EXCHANGE_TYPE_VALUES;
    ...
    private void createQueue(final Shell parent)
    {
        ...
        okButton.addSelectionListener(new SelectionAdapter()
        {
            public void widgetSelected(SelectionEvent e)
            {
                ...
                try
                {
                    _vhmb.createNewQueue(name, owner, durable, false);
