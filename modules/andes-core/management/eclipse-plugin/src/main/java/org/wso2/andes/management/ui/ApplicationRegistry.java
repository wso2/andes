...
public abstract class ApplicationRegistry
{
    ...
    static
    {
        imageRegistry.put(Constants.SUCCESS_IMAGE, 
                org.wso2.andes.management.ui.Activator.getImageDescriptor("/icons/success.gif"));
        imageRegistry.put(Constants.FAILURE_IMAGE, 
                org.wso2.andes.management.ui.Activator.getImageDescriptor("/icons/failure.gif"));
        imageRegistry.put(Constants.CONSOLE_IMAGE, 
                org.wso2.andes.management.ui.Activator.getImageDescriptor("/icons/qpidmc.gif"));
        imageRegistry.put(Constants.CLOSED_FOLDER_IMAGE, 
                org.wso2.andes.management.ui.Activator.getImageDescriptor("/icons/icon_ClosedFolder.gif"));
        ...
        imageRegistry.put(Constants.NOTIFICATION_IMAGE,
                org.wso2.andes.management.ui.Activator.getImageDescriptor("/icons/notifications.gif"));
        imageRegistry.put(Constants.LOGGING_MANAGEMENT_IMAGE,
                org.wso2.andes.management.ui.Activator.getImageDescriptor("/icons/logging_management.gif"));
        imageRegistry.put(Constants.USER_MANAGEMENT_IMAGE,
                org.wso2.andes.management.ui.Activator.getImageDescriptor("/icons/user_management.gif"));
        imageRegistry.put(Constants.CONFIGURATION_MANAGEMENT_IMAGE,
                org.wso2.andes.management.ui.Activator.getImageDescriptor("/icons/configuration_management.gif"));
        imageRegistry.put(Constants.SERVER_INFO_IMAGE,
                org.wso2.andes.management.ui.Activator.getImageDescriptor("/icons/server_information.gif"));
        imageRegistry.put(Constants.VHOST_MANAGER_IMAGE,
                org.wso2.andes.management.ui.Activator.getImageDescriptor("/icons/virtualhost_manager.gif"));
    }
