...
{
    private static final String ID = "org.wso2.andes.management.ui.actions.back";

    public BackAction()
    {
        setText("Back");
        setImageDescriptor(org.wso2.andes.management.ui.Activator.getImageDescriptor("/icons/back.gif"));
        setId(ID);
    }
