 ...
 *
 */
package org.wso2.andes.tools;

import static org.wso2.andes.tools.QpidBench.Mode.BOTH;
import static org.wso2.andes.tools.QpidBench.Mode.CONSUME;
import static org.wso2.andes.tools.QpidBench.Mode.PUBLISH;
...
public class QpidBench
{
    ...
    private static final org.wso2.andes.transport.Connection getConnection
        (Options opts)
    {
        org.wso2.andes.transport.Connection conn =
            new org.wso2.andes.transport.Connection();
    ...
    private static abstract class NativeListener implements SessionListener
    {
        ...
        public void opened(org.wso2.andes.transport.Session ssn) {}

        public void resumed(org.wso2.andes.transport.Session ssn) {}

        public void exception(org.wso2.andes.transport.Session ssn,
                              SessionException exc)
        {
            exc.printStackTrace();
        }

        public void closed(org.wso2.andes.transport.Session ssn) {}
    ...
    {
        final long[] echos = { 0 };
        org.wso2.andes.transport.Connection conn = getConnection(opts);
        org.wso2.andes.transport.Session ssn = conn.createSession();
        ssn.setSessionListener(new NativeListener()
        {
            public void message(org.wso2.andes.transport.Session ssn,
                                MessageTransfer xfr)
            {
                synchronized (echos)
                {
