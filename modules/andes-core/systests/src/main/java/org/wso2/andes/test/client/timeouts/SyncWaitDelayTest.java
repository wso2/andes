 ...
 *
 */
package org.wso2.andes.test.client.timeouts;
...
public class SyncWaitDelayTest extends QpidBrokerTestCase
{
    ...
    public void setUp() throws Exception
    {
        ...
        setConfigurationProperty("virtualhosts.virtualhost." + VIRTUALHOST+".store.class", "org.wso2.andes.server.store.SlowMessageStore");
