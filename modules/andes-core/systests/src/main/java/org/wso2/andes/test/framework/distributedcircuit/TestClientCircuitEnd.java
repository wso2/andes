 ...
 *
 */
package org.wso2.andes.test.framework.distributedcircuit;
 ...
 * {@link org.wso2.andes.test.framework.distributedtesting.TestClient}, and that forms a single publishing or
 * receiving end point in a distributed test {@link org.wso2.andes.test.framework.Circuit}.
 *
 * <p/>When operating in the SENDER role, this circuit end is capable of acting as part of the default circuit test
 * procedure (described in the class comment for {@link org.wso2.andes.test.framework.Circuit}). That is, it will
