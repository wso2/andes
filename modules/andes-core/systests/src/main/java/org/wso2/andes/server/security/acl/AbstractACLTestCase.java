...
public abstract class AbstractACLTestCase extends QpidBrokerTestCase implements ConnectionListener
{
     ...
     * @see org.wso2.andes.test.utils.QpidBrokerTestCase#setUp()
     */
    @Override
     ...
     * {@code org.wso2.andes.test.AccessExampleTest#testExampleMethod} on the {@code testhost} virtualhost would use
