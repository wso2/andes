 ...
 *  under the License.
 */
package org.wso2.andes.server.security.acl;
...
public class ExternalACLJMXTest extends AbstractACLTestCase
{
    ...
    {   
        ...
        catch (Exception e)
        {
            ...
            assertEquals("Cause message incorrect",
                    "org.wso2.andes.AMQSecurityException: Permission denied: queue-name 'kipper' [error code 403: access refused]", e.getCause().getMessage());
        }
    }
    ...
    {   
        ...
        catch (Exception e)
        {
            assertNotNull("Cause is not set", e.getCause());
            assertEquals("Cause message incorrect",
                    "org.wso2.andes.AMQSecurityException: Permission denied: exchange-name 'amq.kipper.failure' [error code 403: access refused]", e.getCause().getMessage());
        }
    }
    ...
    {   
        ...
        catch (Exception e)
        {
            assertNotNull("Cause is not set", e.getCause());
            assertEquals("Cause message incorrect",
                    "org.wso2.andes.AMQSecurityException: Permission denied [error code 403: access refused]", e.getCause().getMessage());
        }
    }
