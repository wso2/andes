...
import org.wso2.andes.test.framework.TestClientDetails;
import org.wso2.andes.test.framework.sequencers.CircuitFactory;
import org.wso2.andes.test.framework.sequencers.InteropCircuitFactory;
import org.wso2.andes.test.utils.ConversationFactory;

import org.wso2.andes.junit.extensions.WrappedSuiteTestDecorator;
 ...
 * <tr><td> Broadcast test invitations and collect enlists. <td> {@link org.wso2.andes.test.utils.ConversationFactory}.
...
public class InteropTestDecorator extends DistributedTestDecorator
{
    ...
    /**
     * Should provide the distributed test sequencer to pass to {@link org.wso2.andes.test.framework.FrameworkBaseCase}
     * tests.
     *
